...
public interface RuntimeModelClientGateway {
    default RuntimeModelExecutionResult execute(long executionNodeId, RuntimeModelDispatch dispatch,
                                                RuntimeCredentialLeaseResolver credentials) {
        return execute(executionNodeId, dispatch, credentials, null);
    }
    RuntimeModelExecutionResult execute(long executionNodeId, RuntimeModelDispatch dispatch,
                                        RuntimeCredentialLeaseResolver credentials,
