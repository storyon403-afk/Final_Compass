...
public record RuntimeToolExecutionContext(long executionId, long nodeId, long userId, String skillKey,
                                          Set<String> allowedTools, Set<String> grantedPermissions,
    ...
    public RuntimeToolExecutionContext(long executionId,long nodeId,long userId,String skillKey,
                                       Set<String> allowedTools,Set<String> grantedPermissions){
