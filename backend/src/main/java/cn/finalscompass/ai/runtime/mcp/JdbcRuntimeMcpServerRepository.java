...
public class JdbcRuntimeMcpServerRepository implements RuntimeMcpServerRepository {
  ...
  public JdbcRuntimeMcpServerRepository(JdbcClient jdbc) {
    this.jdbc = jdbc;
  }
        ...
        .query(
            (result, row) -> {
              ...
              if (transport == RuntimeMcpTransportType.STREAMABLE_HTTP) validateEndpoint(endpoint);
                ...
                throw new IllegalStateException("STDIO MCP endpoint is invalid");
  ...
  private void validateEndpoint(String value) {
    ...
    if (!"https".equalsIgnoreCase(uri.getScheme())
        ...
        || uri.getFragment() != null) throw new IllegalStateException("MCP endpoint is invalid");
  }
}
