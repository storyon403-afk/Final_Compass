...
public class AdminBootstrapService implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        if (username.isBlank() || password.isBlank()) {
            throw new IllegalStateException("APP_ADMIN_USERNAME and APP_ADMIN_PASSWORD must be configured together");
        }
        ...
        boolean exists = jdbc.sql("SELECT COUNT(*) FROM app_user WHERE username=:username")
