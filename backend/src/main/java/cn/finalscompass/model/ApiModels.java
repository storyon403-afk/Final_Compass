 ...
 * 该类被设计为不可实例化的工具类（工具类一般没有对象行为，不应该被扩展），所有内部record都是静态的，便于在不同Controller之间共享和使用。通过这种方式，Final Compass后端实现了数据传输对象的统一管理和验证。
 */
...
public final class ApiModels {
    ...
    /**成员提交指南参考的请求 */                               List<Long> incorporatedSubmissionIds) {}
